<%-- 
    Document   : index
    Created on : 01-sep-2021, 22:49:19
    Author     : emili
--%>
                            ...
                            <nav class="navbar navbar-expand-lg ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="#" href="#">
                                            <a class="nav-link" href="furnitures.jsp">Comprar</a></li>
                                        <li class="nav-item" href="#">
                                            <a class="nav-link" href="Inicio/CargaDatos.jsp">Carga Datos</a></li>
                                         <li class="nav-item" href="#">
                                            <a class="nav-link" href="Inicio/Login.jsp">Login</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <h1 class="trends_text">Mi</h1>
                                        <h1 class="furniture_text">Muebleria</h1>
                                        <P class="lorem_text">Primera Practica Introduccion a la Programacion 2 Usac/Cunoc </P>
