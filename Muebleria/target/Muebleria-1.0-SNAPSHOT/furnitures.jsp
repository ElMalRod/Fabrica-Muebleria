<%-- 
    Document   : furnitures
    Created on : 04-sep-2021, 19:07:18
    Author     : emili
--%>
...
<html>
    ...
    <body>
        ...
        <div class="our_furniture_section layout_padding">
            <div class="container">
                <h1 class="about_taital"> <span style="background-color: #fee421; color: #fff; padding: 0px 5px;">Compras</span></h1>
                <p class="market_text">En proceso xD</p>
            </div>
        </div>
